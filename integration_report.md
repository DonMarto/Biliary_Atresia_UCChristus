# Integration Report: Wiring `fecal_risk` into a Mobile App
...
```
[Mobile App] --(image, JPEG/PNG)--> [Backend service running fecal_risk] --(JSON: probability, label)--> [Mobile App]
```
...
```python
from fecal_risk import load_model
from fecal_risk.persistence import predict_single
